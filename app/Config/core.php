 ...
 */
	Configure::write('Security.salt', 'nZvoyaxwRKLuqCn1FjlXrpJjqVQnsII7OQXy');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '08932741515053664842439741030940');
...
Configure::write('CKFinder', array(
    'path' => 'theme/FLAT/js/plugins/ckfinder',
    'class' => 'CKEDITOR'
));