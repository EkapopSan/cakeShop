<?php 
    $tab_options = array(
        'addBtn' => $this->Html->link(__('<i class="glyphicon-circle_plus"></i> New Attribute'), 
                    array('action' => 'add'),
                    array(
                        'type' => 'button', 
...
<div class="row-fluid">
    <div class="box">
        <div class="box-title">
            ...
            <h3><i class="glyphicon-show_thumbnails_with_lines"></i>Item Attributes</h3>
...
<?php echo $this->Html->script('attribute.index'); ?>