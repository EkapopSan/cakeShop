<?php 
    $tab_options = array(
        'addBtn' => $this->Html->link(__('<i class="glyphicon-circle_plus"></i> New Manufacturer'), 
                    array('action' => 'add'),
                    array(
                        'type' => 'button', 
...
<div class="row-fluid">
    <div class="box">
        <div class="box-title">
            ...
            <h3><i class="glyphicon-global"></i>Manufacturers</h3>
...
<?php echo $this->Html->script('manufacturer.index'); ?>