...
$baseUrl = 'http://cakeshop.igetpart.com/app/webroot/files/';
// $baseUrl = $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].'/app/webroot/files/';			// for internet host with domain
// $baseUrl = $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].'/cakeShop/app/webroot/files/';	// for localhost
...
$config['ResourceType'][] = Array(
		'name' => 'Public',				// Single quotes not allowed
		'url' => $baseUrl . 'public',
...
//        'deniedExtensions' => '');
        ...
        $config['ResourceType'][] = Array(
                'name' => 'System',				// Single quotes not allowed
                'url' => $baseUrl . 'system',
                'directory' => $baseDir . 'system',
                'maxSize' => 0,
                'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
                'deniedExtensions' => '');
